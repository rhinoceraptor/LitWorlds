...
text_handler = (function() {
  function text_handler() {
    ...
    this.arraybuf_to_string = bind(this.arraybuf_to_string, this);
    this.set_line_buffer = bind(this.set_line_buffer, this);
    this.clear_backlog = bind(this.clear_backlog, this);
    this.scroll_backlog = bind(this.scroll_backlog, this);
    this.input_handler = bind(this.input_handler, this);
    this.user_output = bind(this.user_output, this);
